(function(){
  ...
  function deleteHistory(jobId,url){if(!jobId&&!url)return;if(!confirm('この動画を履歴から非表示にしますか？\n動画ファイル本体は削除しません。'))return;hideVideo(url||'',jobId||'');loadHistory(_lastFilterMode)}
