(function(){
  ...
  function style(){
    ...
    s.textContent='#fv-prompt-modal{position:fixed;inset:0;z-index:10000;background:rgba(0,0,0,.75);display:none;align-items:flex-end;padding-bottom:env(safe-area-inset-bottom,0)}#fv-prompt-modal.show{display:flex}#fv-prompt-modal-inner{background:#14171f;border-radius:24px 24px 0 0;width:100%;max-height:72vh;overflow-y:auto;padding:24px 20px 32px}#fv-prompt-modal-label{color:#6b7280;font-size:11px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;margin:0 0 10px}#fv-prompt-modal-text{color:#e8eaf0;font-size:15px;line-height:1.7;white-space:pre-wrap;word-break:break-word;margin:0 0 20px;padding:16px;background:rgba(255,255,255,.05);border-radius:14px;border:1px solid rgba(255,255,255,.09)}#fv-prompt-modal-btns{display:flex;gap:10px}#fv-prompt-modal-copy,#fv-prompt-modal-close{flex:1;height:48px;border:0;border-radius:14px;font-size:15px;font-weight:800;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;gap:6px}#fv-prompt-modal-copy{background:linear-gradient(90deg,#eee8ff,#8ed8ff);color:#050506}#fv-prompt-modal-close{background:#252a35;color:#c0c4d0}#history{display:grid;gap:14px}#history .old{padding:12px;border-radius:20px;display:grid;gap:10px;background:#13161e;border:1px solid rgba(255,255,255,.09)}#history .fv-prompt-wrap{min-width:0}#history .fv-prompt{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;color:#c8cad6;font-weight:700;line-height:1.4;font-size:14px;cursor:pointer;-webkit-user-select:none;user-select:none}#history .fv-meta{display:flex;gap:5px;flex-wrap:wrap;margin-top:6px;color:#6b7280;font-size:11px;font-weight:700}#history .fv-chip{border:1px solid rgba(255,255,255,.1);border-radius:999px;padding:2px 7px;background:rgba(255,255,255,.04)}#history .fv-video-frame{width:100%;height:168px!important;max-height:168px!important;background:#050506;border-radius:14px;overflow:hidden;display:flex;align-items:center;justify-content:center;cursor:pointer}#history .fv-video-frame video{width:100%!important;height:100%!important;max-width:100%!important;max-height:100%!important;object-fit:contain!important;background:#000;border-radius:0;display:block;pointer-events:none}#history .fv-actions-row{display:flex;gap:7px}#history .fv-action{flex:1;height:36px;min-width:0;border:0;border-radius:10px;background:#1e2230;color:#b8bcc8;text-decoration:none;display:inline-flex;align-items:center;justify-content:center;gap:5px;font-size:12px;font-weight:700;padding:0 10px;cursor:pointer;white-space:nowrap}#history .fv-action svg{flex-shrink:0;opacity:.8}#history .fv-fav-btn.on{background:rgba(251,191,36,.14);color:#fde68a;border:1px solid rgba(251,191,36,.22)}#history .fv-delete-one{background:transparent;color:#fca5a5;border:1px solid rgba(251,113,133,.3)}#history .fv-save[disabled]{opacity:.5}@media(max-width:520px){#history .fv-video-frame{height:168px!important}#history .old{padding:10px}#history .fv-actions-row{gap:5px}#history .fv-action{font-size:11px;padding:0 8px;gap:4px}}';
