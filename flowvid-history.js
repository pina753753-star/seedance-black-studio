(function(){
  ...
  function style(){
    ...
    s.textContent='#history{display:grid;gap:14px}#history .old{padding:10px;border-radius:22px;display:grid;gap:9px;background:#1b1e25;border:1px solid rgba(255,255,255,.08)}#history .fv-title-row{display:flex;gap:10px;justify-content:space-between;align-items:flex-start}#history .fv-prompt{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;color:#c8c8d2;font-weight:800;line-height:1.32;font-size:15px}#history .fv-meta{display:flex;gap:6px;flex-wrap:wrap;margin-top:6px;color:#8d94a3;font-size:11px;font-weight:800}#history .fv-chip{border:1px solid rgba(255,255,255,.1);border-radius:999px;padding:3px 7px;background:rgba(255,255,255,.04)}#history .fv-video-frame{width:100%;height:clamp(190px,48vw,250px);background:#050506;border-radius:16px;overflow:hidden;display:flex;align-items:center;justify-content:center}#history .fv-video-frame video{width:100%!important;height:100%!important;max-width:100%!important;max-height:100%!important;object-fit:contain!important;background:#000;border-radius:0;display:block}#history .fv-card-actions{display:flex;gap:8px;align-items:center;justify-content:space-between}#history .fv-left-actions{display:flex;gap:8px}#history .fv-action{min-width:52px;height:36px;border:0;border-radius:11px;background:#2b303a;color:#fff;text-decoration:none;display:grid;place-items:center;font-size:14px;font-weight:900;padding:0 11px}#history .fv-action.fav{width:44px;height:44px;min-width:44px;padding:0;font-size:20px}#history .fv-action.fav.on{background:rgba(251,191,36,.18);color:#fde68a}#history .fv-delete-one{background:transparent;color:#fecdd3;border:1px solid rgba(251,113,133,.35);min-width:58px}@media(max-width:520px){#history .fv-video-frame{height:clamp(180px,50vw,230px)}#history .old{padding:10px}}';
